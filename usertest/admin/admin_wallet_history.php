	            ...
	            <div class="col-lg-3 col-md-6">
	                <div class="card text-center">
	                    <div class="body">
	                        ...
	                        <h3 class="m-b-10"><span class="number count-to" data-from="0" data-to="25020" data-speed="1000" data-fresh-interval="700">0</span></h3> 
	                    </div>
	                </div>
	            </div> 
	            <div class="col-lg-3 col-md-6">
	                <div class="card text-center">
	                    <div class="body">
	                        ...
	                        <h3 class="m-b-10"><span class="number count-to" data-from="0" data-to="65320" data-speed="1000" data-fresh-interval="700">0</span></h3> 
	                    </div>
	                </div>
	            </div> 
	            <div class="col-lg-3 col-md-6">
	                <div class="card text-center">
	                    <div class="body">
	                        ...
	                        <h3 class="m-b-10">P<span class="number count-to" data-from="0" data-to="23205" data-speed="1000" data-fresh-interval="700">0</span></h3> 
	                    </div>
	                </div>
	            </div> 
	        </div>
