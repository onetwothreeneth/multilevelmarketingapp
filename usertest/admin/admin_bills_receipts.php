                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table center-aligned-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="10%"><img src="../user/bills/onetwothreeneth/paybills/globe.png" width="80%"></td>
                                        ...
                                        <tr>
                                            <td width="10%"><img src="../user/bills/onetwothreeneth/paybills/meralco.png" width="80%"></td>
                                            <td>Meralco Bill</td>
                                            <td>T201800002</td>
                                        ...
                                        <tr>
                                            <td width="10%"><img src="../user/bills/onetwothreeneth/paybills/maynilad.png" width="80%"></td>
                                            <td>Maynilad</td>
                                            <td>T201800003</td>
