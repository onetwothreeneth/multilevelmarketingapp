	    ...
	    <ul class="nav navbar-nav navbar-left">
	        <li>
	            <div class="navbar-header">
	                ...
	                <a class="navbar-brand"><span class="m-l-10" style="color:white;">{{ env('APP_NAME') }} DASHBOARD</span></a>
	            </div>
	        </li>        
	        <li>
	            <a>
	        ...
	        <li class="dropdown float-right">
				...
				@include('templates.nav.admin.index')

	        </li>      
	    </ul>
	</nav>

	@include('templates.sidebar.admin.index')
